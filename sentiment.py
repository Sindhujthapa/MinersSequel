...
# 3. Determine Optimal Threshold Using F1
...
# 6. VADER Evaluation on test set
vader_test = df.iloc[y_test.index]
y_vader_test = y_test
vader_pred_test = (vader_test['vader_score'] >= best_thresh).astype(int)
...
# 10. Learning Curves (training vs validation per model, one color per model)
plt.figure(figsize=(10, 7))
